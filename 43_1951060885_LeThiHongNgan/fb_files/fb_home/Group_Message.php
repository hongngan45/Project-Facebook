...
<body>
    ...
    <div style=" background:#F2F2F2; position:absolute; left:25%; top:3.2%; height:8%; width:41.4%; z-index:-1;"> </div>
    
    <form method="post" name="chat_form" onSubmit="return blank_chat_check()">
	
	<div style="position:absolute; left:25.3%; top:2.2%;">
    ...
    <div style="position:absolute; left:59%; top:4%;"> <input type="submit" value="Send" name="Message_send" id="chat_button" onClick="time_get()"> </div>
    </form>
    
<?php
		$que_chat=mysqli_query($conn,"select * from group_chat order by chat_id desc");
?>
    <div style="position:absolute; left:25%; top:4.4%;width: 40%;">
    <table border="0">
<?php
