...
<div style="position:absolute;left:20%; top:7.7%; font-weight:bold; z-index:1;color: #b0b3b8;">  Bài viết  </div>
<div style="position:absolute;left:27%; display:none; top:7.34%; height:1%; width:5%; background-color:#E8E8E8; z-index:1;" id="about_txt_background"> </div>
<div style="position:absolute;left:27%; top:7.7%; font-weight:bold; z-index:1;"> <a href="about.php?id=<?php echo $v_user_id; ?>" style="text-decoration:none; color:#b0b3b8;" onMouseOver="on_about_txt();" onMouseOut="out_about_txt();"> Gioi Thiệu </a>  </div>
<div style="position:absolute;left:35%; top:7.7%; font-weight:bold; z-index:1;"> <a href="about.php" style="text-decoration:none; color:#b0b3b8; "> Bạn bè </a>  </div>

<div style="position:absolute;left:41%; display:none; top:7.34%; height:1%; width:5%; background-color:#E8E8E8; z-index:1;" id="photos_txt_background"> </div>
<div style="position:absolute;left:41%; top:7.7%; font-weight:bold; z-index:1; color:#b0b3b8;"> <a href="photos.php?id=<?php echo $v_user_id; ?>" style="text-decoration:none; color:#b0b3b8;" onMouseOver="on_photos_txt();" onMouseOut="out_photos_txt();">  Photos </a> <samp style="color:#717171;"> <?php echo $photos_count; ?> </samp> </div>
<div style="position:absolute;left:48%; top:7.7%; font-weight:bold; z-index:1;"> <a  style="text-decoration:none; color:#b0b3b8;"> Xem thêm </a>  </div>
<div style="position:absolute;left:60%; top:7.7%; font-weight:bold; z-index:1;"> <a  style="text-decoration:none; color:#b0b3b8;"><i class="bi bi-person-check-fill"></i> Thêm bạn bè </a>  </div>
<div style="position:absolute;left:70%; top:7.7%; font-weight:bold; z-index:1;"> <a  style="text-decoration:none; color:#b0b3b8;"><i class="bi bi-messenger"></i> Nhắn tin  </a>  </div>
<div style="position:absolute;left:79.4%; top:7.7%; font-weight:bold; z-index:1;"> <a  style="text-decoration:none; color:#b0b3b8;"> <i class="bi bi-list"></i> </a>  </div>
...
<!-- post bg-->
	<div style="position:absolute; left:36.8%; top:8.4%; background:#b0b3b8; height:<?php echo $count_bg1+3; ?>60%; width:44%; z-index:-1; box-shadow:0px 2px 5px 1px rgb(0,0,0);" > </div>
    
    
<div style="position:absolute;left:36.8%; top:8.4%;width: 44%;">
<table cellspacing="0">
<?php
...
<!-- About bg-->
	<a href="about.php?id=<?php echo $v_user_id; ?>"> <div style="position:absolute; left:15%; top:8.4%; background:#18191a; height:3%; width:20%; z-index:-1; box-shadow:0px 0px 5px 0px rgb(0,0,0);" onMouseOver="on_about_bg()"> </div>
	<div style="display:none;" id="about_on_bg">	
	<div style="position:absolute; left:15%; top:9.1%; background:#18191a; height:4%; width:20%; z-index:-1;" onMouseOut="out_about_bg()">  </div>
	</div>
	</a>	
	<div style="position:absolute; left:23%; top:8.5%;"> <a href="about.php" style="color:white;text-decoration:none;font-size:23px; font-weight:bold;"> About </a> </div>
	
	<div style="position:absolute; left:15%; top:8.9%; background:#18191a; height:3%; width:20%; z-index:-1; box-shadow:0px 2px 5px 0px rgb(0,0,0);"> </div>	
	<div style="position:absolute;left:19%; top:8.9%; font-weight:bolder; font-size: 20px; color: white;"> Basic Information </div>
	<div style="position:absolute;left:17%; top:9.5%; font-size:15px; color:white;">Birthday</div>
	<div style="position:absolute;left:23%; top:9.5%; font-size:15px;"> <?php echo $v_bday; ?></div>
	<div style="position:absolute;left:17%; top:10%; font-size:15px; color:white;">Gender</div>
	<div style="position:absolute;left:22%; top:10%; font-size:15px;"> <?php echo $v_gender; ?></div>
	<div style="position:absolute;left:17%; top:10.5%; font-size:15px; color:white;">Current location</div>
	<div style="position:absolute;left:17%; top:11%; font-size:15px; color:white;">Hometown</div>
<?php
...
?>
		<div style="position:absolute;left:22%; top:10.5%; font-size:15px; text-transform:capitalize;">  <?php echo $city; ?>  </div>


		<div style="position:absolute;left:22%; top:11%; font-size:15px; text-transform:capitalize;">  <?php echo $hometown; ?>  </div>
...
<!-- Photos bg-->
	<a href="photos.php?id=<?php echo $v_user_id; ?>"> <div style="position:absolute; left:15.3%; top:12.6%; background:#18191a; height:6%; width:19.8%; z-index:-1; box-shadow:0px 0px 5px 0px rgb(0,0,0);" onMouseOver="on_photos_bg()"> </div>
	<div style="display:none;" id="photos_on_bg">	
	<div style="position:absolute; left:15%; top:12%; background:#b0b3b8; height:6%; width:20%; z-index:-1;" onMouseOut="out_photos_bg()">  </div>
	</div>
	</a>	
	<div style="position:absolute; left:23%; top:12.8%;"> <a href="photos.php" style="color:white;text-decoration:none;font-size:17px; font-weight:bold;"> Photos </a> </div>
	
	<div style="position:absolute; left:15.3%; top:13.2%; background:#18191a; height:6%; width:19.8%; z-index:-1; box-shadow:0px 2px 5px 0px rgb(0,0,0);"> </div>	
...
?>
	<div style="position:absolute; left:15.5%; top:13.4%;"> <img src="../../fb_users/<?php echo $v_gender; ?>/<?php echo $v_email; ?>/Profile/<?php echo $profile_img; ?>" height="90" width="78">  </div>
	<div style="position:absolute; left:22%; top:13.4%;"> <img src="../../fb_users/<?php echo $v_gender; ?>/<?php echo $v_email; ?>/Post/<?php echo $img_array[1] ?>" height="90" width="78">  </div>
	<div style="position:absolute; left:28.5%; top:13.4%;"> <img src="../../fb_users/<?php echo $v_gender; ?>/<?php echo $v_email; ?>/Post/<?php echo $img_array[2] ?>" height="90" width="78">  </div>
	<div style="position:absolute; left:15.5%; top:14.6%;"> <img src="../../fb_users/<?php echo $v_gender; ?>/<?php echo $v_email; ?>/Post/<?php echo $img_array[3] ?>" height="90" width="78">  </div>
	<div style="position:absolute; left:22%; top:14.6%;"> <img src="../../fb_users/<?php echo $v_gender; ?>/<?php echo $v_email; ?>/Post/<?php echo $img_array[4] ?>" height="90" width="78">  </div>
	<div style="position:absolute; left:28.5%; top:14.6%;"> <img src="../../fb_users/<?php echo $v_gender; ?>/<?php echo $v_email; ?>/Post/<?php echo $img_array[5] ?>" height="90" width="78">  </div>
	<div style="position:absolute; left:15.5%; top:15.6%;"> <img src="../../fb_users/<?php echo $v_gender; ?>/<?php echo $v_email; ?>/Post/<?php echo $img_array[6] ?>" height="90" width="78">  </div>
	<div style="position:absolute; left:22%; top:15.6%;"> <img src="../../fb_users/<?php echo $v_gender; ?>/<?php echo $v_email; ?>/Post/<?php echo $img_array[7] ?>" height="90" width="78">  </div>
	<div style="position:absolute; left:28.5%; top:15.6%;"> <img src="../../fb_users/<?php echo $v_gender; ?>/<?php echo $v_email; ?>/Post/<?php echo $img_array[8] ?>" height="90" width="78">  </div>
