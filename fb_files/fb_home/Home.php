...
?>
	...
	<div class="main-mid">
        <div class="main-mid-news">
            ...
            <div class="main-mid-news-item">
                <div class="main-mid-news-item-img">
                   <p><img src="img/user-four.jpg"></p>
                </div>
                <div class="main-mid-news-item-avatar">
                    <img src="img/user-four.jpg" alt="">
                </div>
                <div class="main-mid-news-item-nameuser">
                   Đỗ Nhật Trường
                </div>
            ...
            <div class="main-mid-news-item">
                <div class="main-mid-news-item-img">
                   <p><img src="img/user-three.jpg"></p>
                </div>
                <div class="main-mid-news-item-avatar">
                   <img src="img/user-three.jpg">
                </div>
                <div class="main-mid-news-item-nameuser">
                    Tuấn Dương
                </div>
            ...
            <div class="main-mid-news-item">
                <div class="main-mid-news-item-img">
                   <p><img src="img/user-two.jpg"></p>
                </div>
                <div class="main-mid-news-item-avatar">
                    <img src="img/user-two.jpg">
                </div>
                <div class="main-mid-news-item-nameuser">
                    Soo hee
                </div>
	...
	<div style=" background:#18191a; position:absolute; left:22%; top:4%; height:60%; width:61.4%; z-index:-1; box-shadow:0px 2px 5px 1px rgb(0,0,0);"> </div>
	<div style="position:absolute; left:28%; top:4.3%;"> <img src="img/Status.PNG"><input type="button" onClick="upload_close();"  value="Update Status" style="background:#FFFFFF; border:#FFFFFF;"> <img src="img/photo&video.PNG"><input type="button"  value="Add Photos" onClick="upload_open();" name="file" style="background:#FFFFFF; border:#FFFFFF;"></div>
	...
	<div style="position:absolute; left:28%; top:4.6%;">
		<textarea style="height:140; width:800;" name="post_txt" maxlength="511" placeholder="What's on your mind?"></textarea>
        <input type="hidden" name="txt_post_time">
	</div>	
	<div style="background-color: white;position:absolute; left:60%; top:6.1%;">
	<select style="background: transparent; border-bottom:5px;" name="priority"> 
<option value="Public"> Public </option> 
<option value="Private"> Only me </option> 
	</select> 
	</div>
	<div style="position:absolute; left:67%; top:6.1%;"> <input style="color: white;" type="submit" value="post" name="txt" id="post_button" onClick="time_get()"> </div>
	</form>
...
<option value="Private"> Only me </option> 
	...
	<div style="position:absolute; left:24%; top:6.1%;"> <input style="color: white;" type="file" name="file" id="img"> </div>
	<div style="position:absolute; left:67%; top:6.1%;"> <input
	 type="submit" value="post" name="file" id="post_button" onClick="time_get1()"> </div>
	</form>
	
	

	
	<div style="position:absolute;left:24%; top:7%;right:19%;">
	<table cellspacing="0">
<?php
...
?>
	<?php
		...
		<tr>
			...
			<form method="post">  
				...
				<input type="submit" name="delete_post" value=" " style="background-color:#FFFFFF; border:#FFFFFF; background-image:url(img/delete_post.gif); right: 2%; width:3%;"> 
			</form></a> </td>
			<td>  </td>
			<td> </td>
		</tr>
	...
	<tr>
		<td colspan="3" style="padding:7;"> <a href="../fb_view_profile/view_profile.php?id=<?php echo $post_user_id; ?>" style="text-transform:capitalize; text-decoration:none; color:white;font-size:19px" onMouseOver="post_name_underLine(<?php echo $postid; ?>)" onMouseOut="post_name_NounderLine(<?php echo $postid; ?>)" id="uname<?php echo $postid; ?>"> <?php echo $user_name; ?> </a>  </td>
		<td> </td>
		<td> </td>
		<td> </td>
	</tr>
<?php
	...
	<tr>
		<td>   </td>
		<td colspan="3"><img src="../../fb_users/<?php echo $user_gender; ?>/<?php echo $user_Email; ?>/Post/<?php echo $post_img; ?>" width="500" height="500"> </td>
		<td> </td>
		<td> </td>
	</tr>
	<?php
	...
	<tr style="color:red;">
		...
		<?php
			...
			<td style="padding-top:24;">
		<form method="post">
		<input type="hidden" name="postid" value="<?php echo $postid; ?>">
		<input type="hidden" name="userid" value="<?php echo $userid; ?>">
		<input type="submit" value="Unlike" name="Unlike" style="background:#18191a; font-size:18px; color:White;margin-left: 20px;" onMouseOver="unlike_underLine(<?php echo $postid; ?>)" onMouseOut="unlike_NounderLine(<?php echo $postid; ?>)" id="unlike<?php echo $postid; ?>"></form></td>
			<?php
			}
			else
			{?>
		...
		<input type="hidden" name="postid" value="<?php echo $postid; ?>">
		<input type="hidden" name="userid" value="<?php echo $userid; ?>">
		<input type="submit" value="Like" name="Like" style=" background:#18191a; font-size:18px; color:white;margin-left: 20px;" onMouseOver="like_underLine(<?php echo $postid; ?>)" onMouseOut="like_NounderLine(<?php echo $postid; ?>)" id="like<?php echo $postid; ?>"></form></td>
			<?php
			}
		 ?>
		 <?php
	...
	$count_comment=mysqli_num_rows($que_comment);
		...
		<td colspan="3"> &nbsp; <input type="button" value="Comment(<?php echo $count_comment; ?>)" style="background:#18191a; font-size:18px; color:white;margin-left: 270px;padding-top:15px;" onClick="Comment_focus(<?php echo $postid; ?>);" onMouseOver="Comment_underLine(<?php echo $postid; ?>)" onMouseOut="Comment_NounderLine(<?php echo $postid; ?>)" id="comment<?php echo $postid; ?>"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   <span style="color:#999999;">   <?php echo $post_data[4]; ?> </span> </td>
		<td>   </td>
	</tr>
	<tr>
		<td>   </td>
