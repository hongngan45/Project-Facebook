...
<head>
  <title> Quản trị Admin| Quan ly bài đăng</title>
  <meta charset="utf-8">
...
<body class="app sidebar-mini rtl">
  ...
  <aside class="app-sidebar">
    ...
    <ul class="app-menu">
      ...
      <li><a style="text-decoration: none;"  class="app-menu__item " href="../user/quanlynguoidung.php"><i class="bi bi-person-circle"></i>
          <span class="app-menu__label">Quan lý người dùng</span></a></li>
      <li><a style="text-decoration: none;"  class="app-menu__item active" href="../post/quanlybaidang.php"><i class="bi bi-file-earmark-post"></i><span
  ...
  <thead>
    <tr>
      ...
      <th scope="col">Ảnh</th>
      <th scope="col">Thời gian đăng bài viết</th>
        <th scope="col">Quyền riêng tư</th>
      <th scope="col">Sửa</th>
      <th scope="col">Xóa</th>
    </tr>
  </thead>
      ...
      <?php
            ...
            ?>
                        <tr>
                          ...
                          <td><?php echo $row['post_pic']  ;      ?></td>
                          <td><?php echo $row['post_time']  ;      ?></td>
                            <td><?php echo $row['priority']  ;      ?></td>
                          <td><a href="update.php?id=<?php echo $row['post_id'] ?>"><span class="material-icons-outlined">edit</span></a>
                          </td>
                          <td><a href="delete-post.php?id=<?php echo $row['post_id'] ?>"><span class="material-icons-outlined">delete</span></a>
                         </td>
