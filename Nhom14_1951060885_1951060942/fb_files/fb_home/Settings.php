...
<body>
	<div style="background-color: #b0b3b8;position:absolute; left:27%; top:3%;width: 50%;height: 6%; ">
		
	</div>
	<div style="position:absolute; left:37%; top:5%; color:black;font-weight: bold; font-size:20px;"> Name </div>
    <div style="position:absolute; left:47%; top:5%; color:#698B22; font-size:20px; text-transform:capitalize;"> <?php echo $user_name; ?>  </div>
    <div style="position:absolute; left:57%; top:5%"> <i style="color:red;" class="bi bi-pencil-fill" onClick="Change_name()"></i> </div>
  
    
    
    <div style="position:absolute; left:37%; top:6%; color:black;font-weight: bold; font-size:24px;"> Paasword </div>
    <div style="position:absolute; left:47%; top:6%; color:#698B22; font-size:20px;"> ******** </div>
    <div style="position:absolute; left:57%; top:6%"> <i style="color:red;" class="bi bi-pencil-fill" onClick="Change_password()"></i> </div>
   
    <div style="position:absolute; left:50%; top:7%; "> <input type="button" value="Deactivate your account." style="background:#FFF; color:#3B59A4; font-size:15px; border:none;" onClick="delete_account()"> </div>
